...
The guide will introduce them in that order: starting from [how individual pages can be configured](https://docusaurus.io/docs/create-doc/docs-create-doc.mdx), to [how to create a sidebar or multiple ones](./sidebar/index.mdx), to [how to create and manage versions](https://docusaurus.io/docs/versioning), to [how to use multiple docs plugin instances](https://docusaurus.io/docs/docs-multi-instancex).
...
There's also a "blog-only mode" for those who only want to use the blog feature of Docusaurus. You can use the same method detailed above. Follow the setup instructions on [Blog-only mode](https://docusaurus.io/docs/blog).
